...
public class Evaluation {
	...
	public static String[] CLASS_NAMES = {"AUSTR","BELG","BRAZ","CANA","CHINA","CZREP","EEC","FRA","GFR",
	...
	public static void calculatePrecision() throws IOException {
		...
		BufferedReader reader=new BufferedReader(
                new FileReader("C:/Users/wangc/Desktop/naiveBayes/ideaPrj/NBCorpus/output_class/"+"part-r-00000"));
		while(reader.ready()){
