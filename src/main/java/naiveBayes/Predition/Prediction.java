...
public class Prediction {
	...
	Prediction() throws NumberFormatException, IOException{
		// 统计文档总数
		BufferedReader reader = new BufferedReader(new FileReader(new File("C:/Users/wangc/Desktop/naiveBayes/ideaPrj/NBCorpus/output/"+"part-r-00000")));
		double file_total = 0;
		while(reader.ready()){
		...
		// 计算先验概率class_prob
		reader = new BufferedReader(new FileReader(new File("C:/Users/wangc/Desktop/naiveBayes/ideaPrj/NBCorpus/output/"+"part-r-00000")));
        while(reader.ready()){
            String line = reader.readLine();
            String[] args = line.split("\t");
        ...
        //计算单词总数
        reader = new BufferedReader(new FileReader(new File("C:/Users/wangc/Desktop/naiveBayes/ideaPrj/NBCorpus/output_word/"+"part-r-00000")));
        while(reader.ready()){
            String line = reader.readLine();
